...
import { X, ShieldCheck, Database, Cpu, Zap, Loader2, CheckCircle2, AlertCircle, Bell, Send } from 'lucide-react';
...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'jira' | 'llm' | 'notify'>('jira');
